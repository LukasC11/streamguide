...
export async function discoverMovies(params: {
  ...
  if (params.with_watch_providers) fetchParams.with_watch_providers = params.with_watch_providers;
  if (params.watch_region) fetchParams.watch_region = params.watch_region;
  ...
  fetchParams.with_watch_monetization_types = "flatrate";
